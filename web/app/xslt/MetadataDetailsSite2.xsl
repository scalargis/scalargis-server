  ...
  <xsl:template match="//gmd:MD_Metadata | //MD_Metadata">
    ...
    <html>
      <head>
        ...
        <link href="/Modules/Adv.Geoportal/Styles/migSNIG931.css" rel="stylesheet" type="text/css"/>
      </head>
      <body>
        <div class="caixaFixa">
          <img src="/Modules/Adv.Geoportal/Styles/images/logo-metadata-mun-site2.png" width="150" />
          <!--<img src="/Modules/Adv.Geoportal/Styles/images/logo_snig.jpg" height="50" />-->
