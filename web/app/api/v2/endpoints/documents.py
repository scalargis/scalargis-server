...
from ..endpoints import check_user, ns_documents as ns, get_user
...
class ListDir(Resource):
    ...
    def get(self, folder, path):
        ...
        tree = path_hierarchy('api2.documents_list_dir', 'api2.documents_file_dir', request.script_root,
        ...
        for files_key in request.files:
            ...
            for file in files:
                ...
                if dir.upload_overwrite or not os.path.isfile(filepath):
                    ...
                    file_url = url_for('api2.documents_file_dir', folder=folder,
